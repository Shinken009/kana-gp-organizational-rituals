...
El argumento central es el siguiente: en el sector público, la legitimidad no descansa exclusivamente en la eficacia de los procedimientos ni en el cumplimiento de metas. Descansa también, y de forma crítica, en la calidad del vínculo entre quienes trabajan en la organización y entre la organización y los ciudadanos. Los rituales de encuentro son el mecanismo por el que ese vínculo se produce, se refuerza o se destruye cotidianamente. El puente entre ritual y legitimidad opera en tres planos: (1) el ritual genera energía emocional compartida que sostiene el compromiso con la organización (Collins, 2004); (2) ese compromiso se traduce en comportamientos de rol que los ciudadanos perciben como trato digno, reconocimiento y eficacia (Lipsky, 2010); (3) esa percepción acumulada constituye legitimidad pragmática, cognitiva y moral (Suchman, 1995). En América Latina, donde la confianza institucional se construye principalmente a través del trato directo y el vínculo interpersonal —y no a través de indicadores abstractos de rendimiento—, este mecanismo tiene un peso superior al documentado en contextos del Norte Global.
...
El estudio GLOBE —**House et al. (2004)**, *Culture, Leadership, and Organizations: The GLOBE Study of 62 Societies*, Sage— ofrece los datos comparados más sólidos disponibles. El clúster latinoamericano muestra los valores más altos de todos los clústeres en **colectivismo de grupo cercano** (*in-group collectivism*): los individuos expresan orgullo, lealtad y cohesión hacia su organización inmediata. Simultáneamente, el clúster muestra alta distancia de poder en prácticas pero una aspiración significativamente menor en valores, lo que revela una brecha entre la jerarquía formal y el deseo colectivo de mayor horizontalidad. Para KANA-GP, esta combinación es constitutiva: los rituales de encuentro son el espacio donde esa brecha se negocia —momentáneamente— entre la jerarquía instituida y la horizontalidad deseada.
...
**Español:** `rituales organizacionales` &middot; `rituales de encuentro` &middot; `legitimidad institucional` &middot; `cadenas de rituales de interacción` &middot; `cultura organizacional latinoamericana` &middot; `burocracia de contacto` &middot; `valor público` &middot; `KANA-GP`
